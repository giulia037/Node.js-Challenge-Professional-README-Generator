...
const fs = require(`fs`);
const ReadmeOutput = ({ pTitle, pDescription, pInstallation, pUsageInfo, pContrib, pTests }) => `## Node.js-Challenge-Professional-README-Generator
...
.then((data) => {
    const content = ReadmeOutput(answers);
       console.log(data);
